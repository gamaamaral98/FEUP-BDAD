...
CREATE TABLE GESTOR (
  ...
  Contacto TEXT(14) UNIQUE, --Verificar adiconar como chave primaria e FD's
  Email TEXT(40) UNIQUE, -- Verificar adiciionar como chave primaria e FD's
...
CREATE TABLE TRABALHAEM (
  ...
  PRIMARY KEY(Puncionario_ID, Loja_Endereço)
);
